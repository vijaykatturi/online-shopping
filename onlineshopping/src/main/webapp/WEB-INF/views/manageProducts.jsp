...
<div class="container">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4"
									placeholder="Write a descrition" class="form-control" />
								...
								<c:if test="${product.id==0}">
									<div class="text-right">
										...
										<button type="button" data-toggle="modal"
											data-target="#myCategoryModal" class="btn btn-warning btn-xs">Add Category</button>
									</div>
								</c:if>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-8">
								...
								<!-- hiddend fields for the product  -->
								<sf:hidden path="id" />
								<sf:hidden path="code" />
    ...
    <div class="modal fade in" id="myCategoryModal" role="dialog" tabindex="-1">
